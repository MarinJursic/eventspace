    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <Input id="name" placeholder="Enter service name" value={service.name} 
                       onChange={(e) => setService({ ...service, name: e.target.value })} className="mt-2"
                />
            </div>
            ...
            <div>
                ...
                <Textarea id="description" placeholder="Describe your service in detail" value={service.description}
                          onChange={(e) => {
                ...
                <p className="text-sm mt-1">
                    {MAX_DESCRIPTION_WORDS - countWords(service.description ?? "")} words remaining
                </p>
            </div>

            <div>
                <Label htmlFor="type">Service Type <span className="text-red-500">*</span></Label>
                <Select value={service.type} onValueChange={(value) => setService({ ...service, type: value })}>
