...
export default function ReviewStep ({ service }: {service: IServiceClientState}) {

    if(!service.features || !service.policies || !service.availabilityRules) return <></>;
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3">
                                <div>
                                    ...
                                    <p className="font-medium">{service.name || 'Not provided'}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-muted-foreground">Type</p>
                                    <p className="font-medium">{service.type || 'Not provided'}</p>
                                </div>
                                <div>
                            ...
                            <div className="mt-3">
                                ...
                                <p className="font-medium">{service.description || 'Not provided'}</p>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-3">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium">{service.location.city || 'Not provided'}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className="font-medium">{service.location.country || 'Not provided'}</p>
                                </div>
                                <div>
                                    <p className="text-sm text-muted-foreground">Additional Info</p>
                                    <p className="font-medium">{service.location.address || 'None'}</p>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="flex flex-wrap gap-1 mt-1">
                                                {service.features.map((item, index) => (
                                                    <Badge key={index} variant="outline">
                                                        {serviceFeatureValues.find(serviceFeatureValue => serviceFeatureValue._id === item)?.label}
                                                    </Badge>
                                                ))}
                                            </div>
                                        </div>
