...
import { getFeaturedServices } from "@/lib/actions/serviceActions"; // Import the server action
import { SerializedService } from "@/lib/actions/serviceActions"; // Import the type
        ...
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16">
          ...
          <AnimatedSection animation="fade-in" delay={200}>
            <p className="text-base md:text-lg text-muted-foreground mx-auto max-w-2xl">
              Discover top-rated professionals for catering, photography, entertainment, and more.
            </p>
          </AnimatedSection>
        </div>
        ...
        {services && services.length > 0 ? (
            ...
            {services.map((service, index) => (
             ...
             <AnimatedSection animation="fade-in" delay={300}>
                <p className="text-center text-muted-foreground py-8">No featured services available at the moment.</p>
            </AnimatedSection>
        )}
