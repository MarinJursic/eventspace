...
export default function LeafletMap(
    { lat, lng, zoom, onLocationSelect, style, className, leafletLocation, setLeafletLocation}
    : { 
    ...
    const [addressValue, setAddressValue] = useState<ILeafletLocationInfo>(leafletLocation);
    const [selectedPositionValue, setSelectedPositionValue] = useState<LatLngExpression | null>([lat, lng]);
    ...
    return (
        <MapContainer 
            ...
            zoom={zoom} scrollWheelZoom={true} style={style} className={className}
        >
            <TileLayer
            ...
            <MapClickHandler onSelect={onLocationSelect} setAddressValue={setAddressValue} setSelectedPositionValue={setSelectedPositionValue}/>
        </MapContainer>
    );
};